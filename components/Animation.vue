<template>
    <div class="ellipse" id="ellipse">
        <svg width="2000" height="1900" viewBox="0 0 2000 1900" fill="none" xmlns="http://www.w3.org/2000/svg" id="svg">
            <circle id="c1" opacity="1" cx="811.5" cy="811.5" r="780" stroke="#2684FE" stroke-width="5"/>
            <circle id="c2" opacity="0.8" cx="811.5" cy="811.5" r="790" stroke="#2684FE" stroke-width="3"/>
            <circle id="c3" opacity="0.5" cx="811.5" cy="811.5" r="800" stroke="#2E6BFE" stroke-width="3"/>
            <circle id="c4" opacity="0.3" cx="811.5" cy="811.5" r="810" stroke="#248CFE" stroke-width="3"/>
        </svg>
    </div>
    <div class="graph-container">
      <img src="../images/page1/graphbg.png" alt="graph" class="graph">
      <svg class="graphdot" width="199" height="199" viewBox="0 0 199 199" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <circle cx="100" cy="100" r="13" fill="#10CDFC" stroke="#10CDFC" stroke-width="5"/>
