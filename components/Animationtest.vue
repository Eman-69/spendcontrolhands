<template>
    ...
    <svg viewBox="50 100 700 700" id="pathsvg" width="100vw">
      <path
        stroke="none"
        fill="none"
        d="M 400 -100 L 400 700 L 400 -100 L 665 290 L 665 450 L 665 400"
      ></path>
    </svg>
  </template>
  <style scoped>
  ...
  onMounted(() => {
    ...
    ellipsetl.add({
      ...
      scale: [1,1, 1, -0.8, 0, 0],
      opacity: [1,1, 1, -0.8, 0, 0],
      top: ["-125vh","-125vh", "0vh", "-160vh", "-90vh", "-90vh"],
      left: ["-51vw","-51vw", "-51vw", "-22.5vw", "-22.5vw", "-22.5vw"],
      easing: "easeOutQuad",
    });
    graphtl.add({
      targets: ".graph",
    ...
    graphdottl.add({
      targets: ".graphdot",
      opacity: [0,0, 0, 2, -2, -2],
      top: ["34.5vh","34.5vh", "34.5vh", "34.5vh", "73vh", "73vh"],
      right: ["145px","145px", "145px", "145px", "100px", "100px"],
      easing: "linear",
    });
    // questiondottl.add({
    //   targets:".questiondot",
    ...
    c1tl.add({
      targets: "#c1",
      r: [740,740, 780, 780, 780, 780],
      easing: "easeOutElastic",
    });
    c2tl.add({
      targets: "#c2",
      r: [760,760, 900, 900, 900, 900],
      easing: "easeOutElastic",
    });
    c3tl.add({
      targets: "#c3",
      r: [780,780, 1000, 1000, 1000, 1000],
      easing: "easeOutElastic",
    });
    c4tl.add({
      targets: "#c4",
      r: [800,800, 1100, 1100, 1100, 1100],
      easing: "easeOutElastic",
    });
    //   ellipsetl.add({
    //     targets: ".graph",
