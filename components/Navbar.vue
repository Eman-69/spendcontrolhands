...
.nav-links li:hover v-btn::before {
  opacity: 1;
}
...
@media (max-width: 900px) {
  ...
  nav.active .nav-bar .navLogo v-btn {
    opacity: 0;
    transition: all 0.3s ease;
  }
